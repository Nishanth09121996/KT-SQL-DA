...
**4.Find the Premium Amount generated by each Agent and find the top 2 agent based on premium generated.**
...
Output:
| Rank | Agent ID | Agent Name    | Total Premium |
|------|----------|---------------|---------------|
| 1    | 10       | Lisa Thompson | $16,000       |
| 2    | 2        | Jane Smith    | $15,500       |
